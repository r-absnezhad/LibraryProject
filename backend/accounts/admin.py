...
class ProfileAdmin(admin.ModelAdmin):
    ...
    model = Profile
    list_display = ["get_fullname", "membership_code", "get_email", "phone_number", "gender", "image", "membership_date"]
    list_filter = ["gender"]
    search_fields = ["user__email", "membership_code", "first_name", "last_name"]
